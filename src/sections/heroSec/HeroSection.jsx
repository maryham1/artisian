...
function HeroSection() {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: [
        'Connect with <span style="color:#D03531">skilled artisans</span> improve productivity',
      ],
      typeSpeed: 30,
      showCursor: false,
      loop: false,
      ...
      >
        ...
        <div className="animate-fade-in transition-all ease-in duration-300">
          <div className="font-poppins w-[335px] max-w-[360px] laptop:w-[780px] laptop:max-w-[780px] tablet:w-[500px] tablet:max-w-[500px] mt-10 laptop:mt-15">
            <h1
              className="font-bold text-[24px] laptop:text-[46px] tablet:text-[36px]"
              ref={el}
            ></h1>
          ...
          <div className="flex flex-col gap-10 justify-between items-center py-15 laptop:py-0  laptop:flex-row tablet:py-0  tablet:flex-row ">
            <div
              className={`flex flex-col gap-10 order-2 laptop:order-1   tablet:order-1 transition-all ease-in duration-700 ${inView ? "animate-left-in" : ""}`}
              ref={ref}
            >
            ...
            <div
              className={`image flex items-center w-[300px] laptop:w-[700px] tablet:w-[500px] order-1 laptop:order-2 tablet:order-2  transition-all ease-in duration-700 ${inView ? "animate-right-in" : ""}`}
              ref={ref}
            >

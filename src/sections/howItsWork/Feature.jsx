...
function Feature() {
  return (
    <section className="bg-[#F4F4F6] px-5 py-10 laptop:px-15 laptop:py-10 w-full">
      <div className="flex flex-col gap-5 items-center ">
        <div>
          <h4 className="text-[26px] laptop:text-[36px] font-semibold text-black text-center">
            How it work
          </h4>
        ...
        <div className="w-full flex flex-col gap-15 laptop:flex-row laptop:justify-between">
          {steps.map((step, i) => (
            <div
              key={step.id}
              className={`
      ...
      `}
            >
              {/* CARD */}
              <div className="bg-white p-6  w-[290px] max-w-[300px] laptop:w-[350px] rounded-md shadow-md space-y-2">
              ...
              {i === 0 && (
                <img
                  ...
                  className="block laptop:hidden w-[60px] max-w-[100px] -mt-18 ml-70 self-center"
                />
              )}

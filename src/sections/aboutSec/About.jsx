...
function About() {
  return (
    <section className="bg-[#F4F4F6] w-full px-5 py-10 laptop:px-15 laptop:py-10">
      <div className="flex flex-col laptop:flex-row gap-10 justify-between items-center m-auto ">
        <div className="relative w-[400px] laptop:w-[500px] order-2 laptop:order-1">
          <img
            src="\Quick-image\company-associate\Group.png"
            className="relative w-[400px] laptop:w-[500px]"
          />
          <img
            src="\Quick-image\company-associate\female-engr.png"
            className="absolute top-10 left-10 w-[320px] laptop:w-[420px] h-auto"
          />
        </div>
        <div className="w-auto laptop:w-[600px]  flex flex-col gap-5 order-1 laptop:order-2">
          <h4 className="text-[20px] laptop:text-[36px] font-semibold text-black  ">
            Who we are
          </h4>
          <div className="space-y-2">
            <p className="text-[16px] laptop:text-[22px] text-[#4E545F]">

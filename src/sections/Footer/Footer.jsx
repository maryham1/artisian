  ...
  return (
    <section className="bg-[#F4F4F6]   px-5 py-10 laptop:px-15 laptop:py-10 w-full  ">
      <div className="flex flex-col gap-10">
        <div className="flex flex-col laptop:flex-row  gap-10 justify-between ">
          {/* social media */}
          ...
          <div className="space-y-2">
            ...
            <figure className="flex items-center gap-2">
              ...
              <a href="mailto:maryham4real@gmail.com" className="text-[17px]">
                quick@gmail.com
              </a>
            </figure>
            <figure className="flex items-center gap-2">
              <BiPhoneCall className="text-[20px]" />
              <a href="tel:+2349045808495" className="text-[17px]">
                +2349045808495
              </a>
            </figure>
          </div>
          ...
          {/* download the app */}
          <div className="space-y-2">
            <h4 className="text-[20px] font-semibold">Get the App</h4>

    ...
    <section className="bg-[#F4F4F6]   px-5 py-10 pt-10 laptop:px-15 laptop:py-10 laptop:pt-30 pb-0 w-full tablet:px-10 tablet-py-10">
      <div className="flex flex-col items-center ">
        <div className=" w-auto laptop: w-[600px] tablet:w-[600px] space-y-5 ">
          ...
          <figure>
            <p className="text-[15px] laptop:text-[20px] tablet:text-[18px] text-[#a6a7a9] border-2 border-l-0 border-r-0 border-t-0 p-0 pb-2 border-[#a6a7a9]">
          ...
          <ul>
            {faqs?.map((faq, index) => (
              <figure className="flex justify-between border-[1px] p-2  border-l-0 border-r-0 border-t-0  border-[#a6a7a9]">
                <div>
                  <li className="text-[14px] laptop:text-[18px] tablet:text-[16px]">
                    {index + 1}. {faq.question}
                  </li>
                  {showAnswer === index && (
                    <li
                      className=" p-2 pl-4 text-[13px] laptop:text-[16px] tablet:text-[14px]"
                      key={faq.id}
                    >
                      {faq.answer}
                    </li>
